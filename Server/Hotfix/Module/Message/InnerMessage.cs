...
// 向Gate加入用户
	[Message(InnerOpcode.JionPlayerByGateRequest)]
	[ProtoContract]
	public partial class JionPlayerByGateRequest: IRequest
	{
		[ProtoMember(90, IsRequired = true)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.JionPlayerByGateResponse)]
	[ProtoContract]
	public partial class JionPlayerByGateResponse: IResponse
	{
		[ProtoMember(90, IsRequired = true)]
		public int RpcId { get; set; }
...
// 向Map服务器注册Actor
	[Message(InnerOpcode.RegisterGameRequest)]
	[ProtoContract]
	public partial class RegisterGameRequest: IRequest
	{
		[ProtoMember(90, IsRequired = true)]
		public int RpcId { get; set; }
	...
	[Message(InnerOpcode.RegisterGameResponse)]
	[ProtoContract]
	public partial class RegisterGameResponse: IResponse
	{
		[ProtoMember(90, IsRequired = true)]
		public int RpcId { get; set; }
