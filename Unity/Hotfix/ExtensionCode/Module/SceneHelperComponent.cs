...
namespace ETHotfix
{
    ...
    public class SceneHelperComponent : Component
    {
        ...
        /// 创建验证服务器连接
        /// </summary>
        public SessionWrap CreateRealmSession()
        {
            var connetEndPoint = NetworkHelper.ToIPEndPoint(GlobalConfigComponent.Instance.GlobalProto.Address);

            return new SessionWrap(ETModel.Game.Scene.GetComponent<NetOuterComponent>().Create(connetEndPoint));
        }
        ...
        public async Task<SessionWrap> CreateGateSession(string address,long key)
        {
            ...
            try
            {
                ...
                Session = new SessionWrap(gateSession);
        ...
        /// 事件管理组件
        /// </summary>
        public MonoEventComponent MonoEvent => ETModel.Game.Scene.GetComponent<MonoEventComponent>() ??
                                               ETModel.Game.Scene.AddComponent<MonoEventComponent>();

        /// <summary>
        /// 场景管理组件
        /// </summary>
        public SceneManagerComponent SceneManager => ETModel.Game.Scene.GetComponent<SceneManagerComponent>() ??
                                                     ETModel.Game.Scene.AddComponent<SceneManagerComponent>();
